...
<form action="/trackOrder" class="d-flex container" method="POST">
...
<div class="container my-5">
            <div class="row row-cols-1 row-cols-md-2 g-4">
                <!-- Hiển thị từng đơn hàng -->
                    <div class="col-md-12">
                        <a href="/myOrderItem/<?php echo $order['id']; ?>" class="text-decoration-none text-white">
        ...
        <?php else: ?>
        <div class="container my-5">
            <h5 class="text-center text-white">Bạn chưa có đơn hàng nào!</h5>
        </div>
        <?php endif; ?>
</section>
<script>
