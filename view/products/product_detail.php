<main class="container my-4">
    <div class="row">
                ...
                <div class="carousel-inner">
                    ...
                    <?php foreach ($picProducts as $picProduct) : ?>
                        <div class="carousel-item <?= $isFirst ? 'active' : '' ?>">
                            <img src="http://localhost:8000/<?= htmlspecialchars($picProduct['imagePath']) ?>" class="d-block w-100" alt="Sản phẩm">
                        </div>
                        <?php $isFirst = false; ?>
                    <?php endforeach; ?>
                </div>
        ...
        <div class="col-md-6">
            ...
            <div class="mb-3">
                ...
                <?php foreach ($productItems as $productItem): ?>
                    <?php if (!in_array($productItem['idSize'], $displayedSizes)): 
                        ...
                        <button type="button" class="btn btn-outline-dark size-option" data-size="<?= $productItem['idSize'] ?>">
            ...
            <div class="mb-3">
                ...
                <?php foreach ($productItems as $productItem): ?>
                    <?php if (!in_array($productItem['idColor'], $displayedColors)): 
                        ...
                        <button type="button" class="btn btn-outline-dark color-option" data-color="<?= $productItem['idColor'] ?>">
            ...
            <!-- hien thi sku -->
             <p class="text-dark fw-bold"> SKU: <span class="fw-normal" id="product-sku">---</span></p>
             <!-- hien thi ton kho -->
             <p class="text-dark fw-bold"> Còn: <span class="fw-normal" id="product-inventory">---</span></p>
            <!-- Hiển thị giá -->
            <p class="text-danger" style="font-size: 24px; font-weight: bold;">Giá: <span id="product-price">0</span></p>
            ...
            <div class="col-md-3">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <input type="text" name = "quantity" id="quantity" value="1" class="form-control text-center" style="width: 70px;">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updatePrice() {
        if (selectedSize && selectedColor) {
            const variant = variants.find(v => v.idSize == selectedSize && v.idColor == selectedColor);
            document.getElementById('product-price').textContent = variant ? variant.price.toLocaleString() + " VNĐ" : "Sản phẩm hiện tại đang hết hàng!";
        } else {
    ...
    document.getElementById('add-to-cart').addEventListener('click', function () {
        if (!selectedSize || !selectedColor) {
            ...
            return;
        }else if(parseInt(quantityInput.value) == 0 || isNaN(parseInt(quantityInput.value)) || parseInt(quantityInput.value) > parseInt(document.getElementById('product-inventory' ).textContent)){
